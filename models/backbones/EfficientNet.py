...
def from_name(model_name, *, n_classes=1000, pretrained=False):
    return _get_model_by_name(model_name, classes=n_classes, pretrained=pretrained)


# re-implementation of EfficientNet.Encoder
class Encoder(nn.Module):
    def __init__(self, num_classes, model_name):
        super().__init__()

        block_args_list, global_params = get_efficientnet_params(model_name, override_params={'num_classes': num_classes})
