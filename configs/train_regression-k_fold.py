conf=dict(
  ...
  dataloader_train=dict(
    name='Image2Vector',
    mode='train',
    data_path_folds=['/path/to/train_fold_0.csv',
  ...
  dataloader_valid=dict(
    name='Image2Vector',
    mode='valid',
    data_path_folds=['/path/to/valid_fold_0.csv',
